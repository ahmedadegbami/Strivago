...
accomdationRouter.post("/", async (req, res, next) => {
  try {
...
accomdationRouter.get("/:accomdationId", async (req, res, next) => {
  try {
...
accomdationRouter.put("/:accomdationId", async (req, res, next) => {
  try {
...
accomdationRouter.delete("/:accomdationId", async (req, res, next) => {
  try {
